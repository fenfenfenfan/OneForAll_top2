...
# For backward compatibility, we use basic modules from paddleseg
...
class PanopticDeepLabHead(nn.Layer):
    ...
    Args:
        ...
        backbone_channels (tuple): The channels of backbone features.
    ...
    def __init__(self, num_classes, backbone_indices, backbone_channels,
                 ...
                 align_corners, low_level_channels_projects, **instance_kwargs):
        super().__init__()
        backbone_channels = [backbone_channels[i] for i in backbone_indices]
        ...
        self.instance_decoder = SinglePanopticDeepLabDecoder(
            ...
            backbone_channels=backbone_channels,
            aspp_ratios=aspp_ratios,
            aspp_out_channels=instance_kwargs['instance_aspp_out_channels'],
            decoder_channels=instance_kwargs['instance_decoder_channels'],
            align_corners=align_corners,
            low_level_channels_projects=instance_kwargs[
                'instance_low_level_channels_projects'])
        self.instance_head = SinglePanopticDeepLabHead(
            num_classes=instance_kwargs['instance_num_classes'],
            decoder_channels=instance_kwargs['instance_decoder_channels'],
            head_channels=instance_kwargs['instance_head_channels'],
