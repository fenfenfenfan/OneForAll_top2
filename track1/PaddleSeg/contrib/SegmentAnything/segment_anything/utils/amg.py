...
def batched_mask_to_box(masks: paddle.Tensor) -> paddle.Tensor:
    ...
    #in_height_coords = in_height_coords + w * ((~(in_height.cast('bool')).astype('uint8')+2).astype('bool').cast('int32'))
    ...
    #in_width_coords = in_width_coords + w * ((~(in_width.cast('bool')).astype('uint8')+2).astype('bool').cast('int32'))
