...
function func_paddle2onnx(){
    ...
    # paddle2onnx
    trans_model_log_path="${LOG_PATH}/trans_model.log"
    ...
    trans_model_cmd="${padlle2onnx_cmd} ${set_dirname} ${set_model_filename} ${set_params_filename} ${set_save_model} ${set_opset_version} ${set_enable_onnx_checker} >${trans_model_log_path} 2>&1"
